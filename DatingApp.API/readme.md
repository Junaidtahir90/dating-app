# Allow CORS
## Description
1. Add Package CORs package may be vary as per technology/version,I ma using .net core so
Microsoft.AspNetCore.Cors (2.2.0)
2. Add Below code in Startup.cs in ConfigureServices method/where we add services
...
3.Add below code in  
Code :: app.UseCors("CorsPolicy");

4.Rebuild Solution,Error gone
